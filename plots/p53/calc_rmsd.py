...
def parse_arg():
    parser = argparse.ArgumentParser(
        description='This is a program to calculate rmsd in each enhanced sampling, python calc_rmsd.py -infiledir ./ '
                    '-outfiledir ./ -iter_start 0 -iter_end 10 -num_walkers 30 -tprfile crystal_nowater.tpr '
                    '-reference crystal_protein.gro -indexfile index_p.ndx')
